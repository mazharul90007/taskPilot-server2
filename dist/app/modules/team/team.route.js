...
router.patch("/:id", (0, auth_1.default)(client_1.UserRole.admin, client_1.UserRole.leader), (0, validateRequest_1.default)(team_validation_1.TeamValidation.updateTeamValidationSchema), team_controller_1.teamController.updateTeam);
